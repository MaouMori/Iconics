      ...
      <main className="lore-shell">
        <aside className="sidebar-card">
          ...
          <div className="image-slot portrait paper-slot">
            <img src="/images/mansao.png" alt="Mansão da ICONICS" className="slot-image" />
          </div>
          ...
          <div className="image-slot landscape">
            <img src="/images/logo.png" alt="Símbolo da ICONICS" className="slot-image" />
          </div>
        ...
        <section className="content-area">
          <article className="section-card" id="origem">
            ...
            <div className="two-col">
              ...
              <div className="image-slot square">
                <img src="/images/origem.png" alt="Origem da ICONICS" className="slot-image" />
              </div>
            </div>
          </article>
          ...
          <article className="section-card" id="simbolos">
            ...
            <div className="two-col reverse">
              <div className="image-slot square">
                <img src="/images/simbolo.png" alt="Símbolos da ICONICS" className="slot-image" />
              </div>
              ...
              <div className="text-col">
                ...
                <blockquote>“Influência, Criatividade e Poder.”</blockquote>
              </div>
            </div>
          </article>
          ...
          <article className="section-card" id="valores">
            ...
            <div className="two-col">
              ...
              <div className="image-slot square">
                <img src="/images/valores.png" alt="Valores da ICONICS" className="slot-image" />
              </div>
            </div>
          </article>
